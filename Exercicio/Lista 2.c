...
void exibirPlaylistPorNome(struct Musica* cabeca, struct Musica* atual) {
    ...
    printf("Playlist foi ordenada pelo nome das musicas:\n");
...
void removerMusica(struct Musica** cabeca, char titulo[]) {
    ...
    if (musicaARemover == NULL) {
        printf("Musica nao foi encontrada na playlist.\n");
        return;
    }
    ...
    printf("A musica selecionada foi removida!\n");
}
...
int main() {
    ...
    do {
        printf("\n=========================INICIO=========================\n\n");
        printf("1. Mostrar a playlist na ordem de cadastro\n");
        printf("2. Exibir playlist ordenada pelo nome das musicas\n");
        printf("3. Adicionar uma nova musica\n");
        printf("4. Remover uma musica\n");
        printf("5. Procurar uma musica\n");
