...
void exibirPlaylistPorOrdem(struct Musica *cabeca, struct Musica *atual)
{
    ...
    printf("Playlist com ordem de cadastro:\n");
    do
    {
        printf("%s - %s", iterador->artista, iterador->titulo);
        if (iterador == atual)
        {
            printf(" (Tocando no momento)");
        }
        printf("\n");
...
void exibirPlaylistPorNome(struct Musica *cabeca, struct Musica *atual)
{
    ...
    printf("Playlist com ordem pelo nome das musicas:\n");
...
void removerMusica(struct Musica **cabeca, char titulo[])
{
    ...
    printf("Musica selecionada foi removida\n");
}
...
void salvarPlaylistEmArquivo(struct Musica *cabeca)
{
    ...
    FILE *arquivo = fopen("C:\\Users\\leona\\OneDrive\\Área de Trabalho\\Exercicio\\musicas.txt", "w");
    if (arquivo == NULL)
    {
...
int main()
{
    ...
    FILE *arquivo = fopen("C:\\Users\\leona\\OneDrive\\Área de Trabalho\\Exercicio\\musicas.txt", "r");
    if (arquivo == NULL)
    {
    ...
    do
    {
        ...
        printf("2. Exibição da playlist que foi ordenada pelo nome das musicas\n");
        printf("3. Adicionando nova musica\n");
        printf("4. Removendo musica\n");
        printf("5. Buscando a musica\n");
        printf("6. Passando para a proxima musica\n");
        printf("7. Voltando a musica anterior\n");
        ...
        case 2:
            ...
            break;
        case 3:
            printf("Insira o nome do artista desejado: ");
            fgets(novoArtista, sizeof(novoArtista), stdin);
            novoArtista[strcspn(novoArtista, "\n")] = 0;
            printf("Informe o nome da musica desejada: ");
        ...
        case 4:
            ...
            break;
        case 5:
            printf("Insira o nome da musica para ser buscada: ");
            ...
            if (musicaEncontrada)
            {
                printf("Nao foi possivel encontrar a musica: %s - %s\n", musicaEncontrada->artista, musicaEncontrada->titulo);
            }
            else
            {
                printf("Nao foi possivel encontrar a musica desejada!\n");
            }
            break;
        case 6:
            atual = proximaMusica(atual);
            printf("Musica tocando no momento: %s - %s\n", atual->artista, atual->titulo);
            break;
        case 7:
        ...
        case 8:
            ...
            break;
        case 9:
            printf("Muito obrigado por escutar o...\n");
            break;
        default:
